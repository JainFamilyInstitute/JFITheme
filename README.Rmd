---
title: "JFITheme: A ggplot2 Theme for JFI"
output: github_document
---

```{r setup, include=FALSE} 
knitr::opts_chunk$set(warning = FALSE, message = FALSE, fig.width = 7, fig.height = 5, dpi = 200)
library(JFITheme)
library(ggplot2)
library(dplyr)
library(tidyr)
...
**Note for Map Users:** The mapping examples require the `sf` package. This package may have system dependencies (like GDAL, GEOS, and PROJ) that need to be installed first. Please see the [`sf` installation guide](https://r-spatial.github.io/sf/#installing) for details.
...
```{r donut-chart, fig.width=6, fig.height=6.5}
...
```{r map-chart, fig.width=8.72, fig.height=6.1}
